...
if (document.querySelector('.slider-main__body')) {
	new Swiper('.slider-main__body', {
		...
		navigation: {
			nextEl: '.slider-main .arrow-controls__next',
			prevEl: '.slider-main .arrow-controls__prev',
		},
		// breakpoints: {
		// 320: {
		// 	slidesPerView: 1,
...
if (document.querySelector('.slider-rooms__body')) {
	new Swiper('.slider-rooms__body', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-rooms .arrow-controls__next',
			prevEl: '.slider-rooms .arrow-controls__prev',
		}
	});
}
if (document.querySelector('.slider-tips__body')) {
	new Swiper('.slider-tips__body', {
		...
		// Arrows
		navigation: {
			nextEl: '.tips__arrows .arrow-controls__next',
			prevEl: '.tips__arrows .arrow-controls__prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.1,
...
window.onload = function () {
   ...
   function documentActions(e) {
      ...
      if (isMobile.any()) {
         ...
         if (targetElement.closest('.products__item')) {
            const productsElement = targetElement.closest('.products__item');
            const productsMenu = productsElement.querySelector('.products__menu');
            productsMenu.classList.toggle('show');
         }
         else {
            const productsMenuAll = document.querySelectorAll('.products__menu');
            for (let i = 0; i < productsMenuAll.length; i++) {
               productsMenuAll[i].classList.remove('show');
            }
         }
